...
from demonet.conversion.common.parser import Parser
from demonet.conversion.pytorch.pytorch_graph import PytorchGraph
...
class PytorchParser(Parser):
    ...
    def run(self, output_path):
        self.gen_IR()
        self.save_to_proto('{}.prototxt'.format(output_path))
        self.save_weights('{}.caffemodel'.format(output_path))
    ...
    def gen_IR(self):
        ...
        for layer in self.src_graph.topological_sort:
            ...
            if len(bottoms) == 0:
                ...
                layer_data = func()
                self.layer_names.append(layer_data)
                bottoms.append('data')
            ...
            if hasattr(self, "rename_" + node_type):
                ...
                if(node_type == "BatchNormalization"):
                    self.layer_names.append(layer_data[0])
                    self.layer_names.append(layer_data[1])
                    # self.layer_names.append(layer_data)
                else:
                    self.layer_names.append(layer_data)
    ...
    def rename_UNKNOWN(self, source_node):
        ...
        print("PyTorch parser has not supported operator [{}] with name [{}].".format(
