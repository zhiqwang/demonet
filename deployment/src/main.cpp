...
int main(int argc, const char* argv[]) {
  cxxopts::Options parser(argv[0], "A LibTorch inference implementation of the detr");

  // TODO: add other args
  parser.allow_unrecognised_options().add_options()
      ("checkpoint", "detr.torchscript.pt path", cxxopts::value<std::string>())
  ...
  // auto detections = output->elements()[1];
