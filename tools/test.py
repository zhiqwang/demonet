...
from models.utils import (
    load_classes, non_max_suppression, plot_images,
    scale_coords, coco80_to_coco91_class,
    xywh2xyxy, xyxy2xywh, clip_coords, floatn,
    bbox_iou, ap_per_class, attempt_download,
...
def test(
    ...
    if save_json and map and len(jdict):
        try:
            ...
            cocoGt = COCO('./data-bin/coco2014/annotations/instances_val2014.json')  # initialize COCO ground truth api
